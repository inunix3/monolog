...
static int token_printf_cb(const void *data, void *udata) {
    ...
    return printf(
        ...
        "}",
        tok->kind, tok->src, tok->len, tok->valid ? "true" : "false",
        tok->src_info.line, tok->src_info.col
    );
}
...
TEST invalid_tokens(void) {
    ...
    Token expected[] = {
        ...
        {TOKEN_COMMA, input + 5, 1, true, {1, 6}},
        {TOKEN_IDENTIFIER, input + 6, 3, true, {1, 7}},
        {TOKEN_MUL, input + 9, 1, true, {1, 10}},
        {TOKEN_UNKNOWN, input + 10, 3, false, {1, 11}},
        {TOKEN_HASHTAG, input + 13, 1, true, {1, 14}},
        {TOKEN_DOLAR, input + 14, 1, true, {1, 15}},
...
TEST single_operators(void) {
    ...
    Token expected[] = {
        {TOKEN_ASSIGN, input, 1, true, {1, 1}},
        {TOKEN_COMMA, input + 1, 1, true, {1, 2}},
        {TOKEN_SEMICOLON, input + 2, 1, true, {1, 3}},
        {TOKEN_PLUS, input + 3, 1, true, {1, 4}},
        {TOKEN_MINUS, input + 4, 1, true, {1, 5}},
        {TOKEN_DIV, input + 5, 1, true, {1, 6}},
        {TOKEN_MOD, input + 6, 1, true, {1, 7}},
        {TOKEN_LPAREN, input + 7, 1, true, {1, 8}},
        {TOKEN_RPAREN, input + 8, 1, true, {1, 9}},
        {TOKEN_LBRACKET, input + 9, 1, true, {1, 10}},
        {TOKEN_RBRACKET, input + 10, 1, true, {1, 11}},
        {TOKEN_LBRACE, input + 11, 1, true, {1, 12}},
        {TOKEN_RBRACE, input + 12, 1, true, {1, 13}},
        {TOKEN_DOLAR, input + 13, 1, true, {1, 14}},
        {TOKEN_HASHTAG, input + 14, 1, true, {1, 15}},
        {TOKEN_QUEST, input + 15, 1, true, {1, 16}},
        {TOKEN_EXCL, input + 16, 1, true, {1, 17}},
        {TOKEN_LESS, input + 17, 1, true, {1, 18}},
        {TOKEN_GREATER, input + 18, 1, true, {1, 19}},
...
TEST double_operators(void) {
    ...
    Token expected[] = {
        ...
        {TOKEN_EQUAL, input + 3, 2, true, {1, 4}},
        {TOKEN_LESS_EQUAL, input + 6, 2, true, {1, 7}},
        {TOKEN_GREATER_EQUAL, input + 9, 2, true, {1, 10}},
        {TOKEN_INC, input + 12, 2, true, {1, 13}},
...
TEST double_operators_cannot_be_splitted(void) {
    ...
    ASSERT_EQ(13, g_tokens.len);

    Token expected[] = {
        {TOKEN_EXCL, input, 1, true, {1, 1}},
        {TOKEN_ASSIGN, input + 2, 1, true, {1, 3}},
        {TOKEN_ASSIGN, input + 4, 1, true, {1, 5}},
        {TOKEN_ASSIGN, input + 6, 1, true, {2, 1}},
        {TOKEN_LESS, input + 8, 1, true, {2, 3}},
        {TOKEN_ASSIGN, input + 10, 1, true, {2, 5}},
        {TOKEN_GREATER, input + 12, 1, true, {2, 7}},
        {TOKEN_ASSIGN, input + 17, 1, true, {2, 12}},
        {TOKEN_PLUS, input + 19, 1, true, {2, 14}},
        {TOKEN_PLUS, input + 21, 1, true, {2, 16}},
        {TOKEN_MINUS, input + 23, 1, true, {2, 18}},
        {TOKEN_MINUS, input + 25, 1, true, {2, 20}},
        {TOKEN_EOF, input + strlen(input), 0, true, {2, 21}}
    };
...
TEST identifiers_and_operators(void) {
    ...
    Token expected[] = {
        {TOKEN_LBRACE, input, 1, true, {1, 1}},
        {TOKEN_IDENTIFIER, input + 1, 6, true, {1, 2}}, /* printf */
        {TOKEN_LPAREN, input + 7, 1, true, {1, 8}},
        {TOKEN_IDENTIFIER, input + 8, 3, true, {1, 9}}, /* fmt */
        {TOKEN_RPAREN, input + 11, 1, true, {1, 12}},
        {TOKEN_COMMA, input + 12, 1, true, {1, 13}},
        {TOKEN_IDENTIFIER, input + 13, 4, true, {1, 14}}, /* puts */
        {TOKEN_LPAREN, input + 17, 1, true, {1, 18}},
        {TOKEN_IDENTIFIER, input + 18, 7, true, {1, 19}}, /* strings */
        {TOKEN_LBRACKET, input + 25, 1, true, {1, 26}},
        {TOKEN_IDENTIFIER, input + 26, 3, true, {1, 27}}, /* idx */
        {TOKEN_RBRACKET, input + 29, 1, true, {1, 30}},
        {TOKEN_RPAREN, input + 30, 1, true, {1, 31}},
        {TOKEN_MUL, input + 31, 1, true, {1, 32}},
        {TOKEN_IDENTIFIER, input + 32, 8, true, {1, 33}}, /* __int128 */
        {TOKEN_PLUS, input + 40, 1, true, {1, 41}},
        {TOKEN_MINUS, input + 41, 1, true, {1, 42}},
        {TOKEN_DIV, input + 42, 1, true, {1, 43}},
        {TOKEN_MOD, input + 43, 1, true, {1, 44}},
        {TOKEN_IDENTIFIER, input + 44, 5, true, {1, 45}}, /* t_3__ */
        {TOKEN_SEMICOLON, input + 49, 1, true, {1, 50}},
        {TOKEN_RBRACE, input + 50, 1, true, {1, 51}},
...
TEST identifiers_and_operators_separated_with_whitespaces(void) {
    ...
    Token expected[] = {
        ...
        {TOKEN_LPAREN, input + 11, 1, true, {1, 12}},
        {TOKEN_IDENTIFIER, input + 13, 3, true, {1, 14}}, /* fmt */
        {TOKEN_RPAREN, input + 17, 1, true, {1, 18}},
        {TOKEN_COMMA, input + 22, 1, true, {1, 23}},
        {TOKEN_IDENTIFIER, input + 25, 4, true, {2, 2}}, /* puts */
        {TOKEN_LPAREN, input + 31, 1, true, {2, 8}},
        {TOKEN_IDENTIFIER, input + 33, 7, true, {2, 10}}, /* strings */
        {TOKEN_LBRACKET, input + 43, 1, true, {2, 20}},
        {TOKEN_IDENTIFIER, input + 45, 3, true, {3, 1}}, /* idx */
        {TOKEN_RBRACKET, input + 49, 1, true, {3, 5}},
        {TOKEN_RPAREN, input + 52, 1, true, {3, 8}},
        {TOKEN_MUL, input + 54, 1, true, {3, 10}},
        {TOKEN_IDENTIFIER, input + 56, 8, true, {3, 12}}, /* __int128 */
        {TOKEN_PLUS, input + 67, 1, true, {3, 23}},
        {TOKEN_MINUS, input + 72, 1, true, {3, 28}},
        {TOKEN_DIV, input + 75, 1, true, {3, 31}},
        {TOKEN_MOD, input + 78, 1, true, {3, 34}},
        {TOKEN_IDENTIFIER, input + 84, 5, true, {3, 40}}, /* t_3__ */
        {TOKEN_SEMICOLON, input + 90, 1, true, {3, 46}},
        {TOKEN_RBRACE, input + 92, 1, true, {3, 48}},
...
TEST empty_string_returns_string_token(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 2, true, {1, 1}},
...
TEST string_returns_string_token(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 15, true, {1, 1}},
...
TEST open_string(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 14, false, {1, 1}},
...
TEST multiline_string(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 14, true, {1, 1}},
...
TEST multiline_open_string(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 13, false, {1, 1}},
        {TOKEN_EOF, input + strlen(input), 0, true, {3, 4}}
    };
...
TEST embedded_strings(void) {
    ...
    Token expected[] = {
        {TOKEN_STRING_LIT, input, 19, true, {1, 1}},
        {TOKEN_EOF, input + strlen(input), 0, true, {1, 20}}
    };
...
TEST keywords(void) {
    ...
    Token expected[] = {
        {TOKEN_IF, input, 2, true, {1, 1}},
        {TOKEN_ELSE, input + 3, 4, true, {1, 4}},
        {TOKEN_FOR, input + 8, 3, true, {1, 9}},
        {TOKEN_WHILE, input + 12, 5, true, {1, 13}},
        {TOKEN_RETURN, input + 18, 6, true, {1, 19}},
        {TOKEN_BREAK, input + 25, 5, true, {1, 26}},
        {TOKEN_CONTINUE, input + 31, 8, true, {1, 32}},
        {TOKEN_NIL, input + 40, 3, true, {1, 41}},
        {TOKEN_INT, input + 44, 3, true, {1, 45}},
        {TOKEN_VOID, input + 48, 4, true, {1, 49}},
        {TOKEN_STRING, input + 53, 6, true, {1, 54}},
...
TEST prog1_factorial(void) {
    ...
    Token expected[] = {
        {TOKEN_INT, input, 3, true, {1, 1}},
        {TOKEN_IDENTIFIER, input + 4, 9, true, {1, 5}},
        {TOKEN_LPAREN, input + 13, 1, true, {1, 14}},
        {TOKEN_INT, input + 14, 3, true, {1, 15}},
        {TOKEN_IDENTIFIER, input + 18, 1, true, {1, 19}},
        {TOKEN_RPAREN, input + 19, 1, true, {1, 20}},
        {TOKEN_LBRACE, input + 21, 1, true, {1, 22}},
        {TOKEN_INT, input + 24, 3, true, {2, 2}},
        {TOKEN_IDENTIFIER, input + 28, 1, true, {2, 6}},
        {TOKEN_ASSIGN, input + 30, 1, true, {2, 8}},
        {TOKEN_INTEGER, input + 32, 1, true, {2, 10}},
        {TOKEN_SEMICOLON, input + 33, 1, true, {2, 11}},
        {TOKEN_INT, input + 37, 3, true, {4, 2}},
        {TOKEN_IDENTIFIER, input + 41, 1, true, {4, 6}},
        {TOKEN_ASSIGN, input + 43, 1, true, {4, 8}},
        {TOKEN_INTEGER, input + 45, 1, true, {4, 10}},
        {TOKEN_SEMICOLON, input + 46, 1, true, {4, 11}},
        {TOKEN_WHILE, input + 49, 5, true, {5, 2}},
        {TOKEN_LPAREN, input + 55, 1, true, {5, 8}},
        {TOKEN_IDENTIFIER, input + 56, 1, true, {5, 9}},
        {TOKEN_LESS_EQUAL, input + 58, 2, true, {5, 11}},
        {TOKEN_IDENTIFIER, input + 61, 1, true, {5, 14}},
        {TOKEN_RPAREN, input + 62, 1, true, {5, 15}},
        {TOKEN_LBRACE, input + 64, 1, true, {5, 17}},
        {TOKEN_IDENTIFIER, input + 68, 1, true, {6, 3}},
        {TOKEN_ASSIGN, input + 70, 1, true, {6, 5}},
        {TOKEN_IDENTIFIER, input + 72, 1, true, {6, 7}},
        {TOKEN_MUL, input + 74, 1, true, {6, 9}},
        {TOKEN_IDENTIFIER, input + 76, 1, true, {6, 11}},
        {TOKEN_SEMICOLON, input + 77, 1, true, {6, 12}},
        {TOKEN_INC, input + 82, 2, true, {8, 3}},
        {TOKEN_IDENTIFIER, input + 84, 1, true, {8, 5}},
        {TOKEN_SEMICOLON, input + 85, 1, true, {8, 6}},
        {TOKEN_RBRACE, input + 88, 1, true, {9, 2}},
        {TOKEN_RETURN, input + 92, 6, true, {11, 2}},
        {TOKEN_IDENTIFIER, input + 99, 1, true, {11, 9}},
        {TOKEN_SEMICOLON, input + 100, 1, true, {11, 10}},
        {TOKEN_RBRACE, input + 102, 1, true, {12, 1}},
